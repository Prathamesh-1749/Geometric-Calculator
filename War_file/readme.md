...
(Note:- If you make any change in Java Servlets code the compile it with the ("javac LoginServlet.java")command in the command prompt, and if you want to compile a Java package, then use("javac -d . RegistrationServlet.java")command in the command prompt.)
